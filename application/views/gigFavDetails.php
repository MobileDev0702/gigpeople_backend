...
<div class="container">
  ...
  <img class="mySlides" src="<?php echo base_url();?>/assets/images/gig/3.jpg" style="width:100%">
  <img class="mySlides" src="<?php echo base_url();?>/assets/images/gig/2.jpg" style="width:100%">
  <img class="mySlides" src="<?php echo base_url();?>/assets/images/gig/2.jpg" style="width:100%">
...
<p>Category : Programming & Technology</p>
<p>Sub Category : Designing</p>
...
<p>Revision  : 2 </p>
			...
			<!-- Boxed List / End -->
				...
				<div class="centered-button margin-top-35">
					<a href="#small-dialog-2" class="popup-with-zoom-anim button button-sliding-icon">Order Now<i class="icon-material-outline-arrow-right-alt"></i></a>
				</div>
			...
			<div class="popup-tab-content" id="tab">
				...
				<form method="post" id="apply-now-form">
				    ...
				    <div class="submit-field">
						...
						<input type="number" class="with-border" placeholder="Number Of Qty">
					</div>

					<div class="input-with-icon-left">
					
						<textarea class="input-text with-border" name="name" id="name" placeholder="Description"  r></textarea>
					</div>
				...
				<!-- Button -->
				<a href="<?php echo site_url()?>/welcome/checkout" class="button margin-top-35 full-width button-sliding-icon ripple-effect" type="submit" form="apply-now-form">Submit<i class="icon-material-outline-arrow-right-alt"></i></a>
