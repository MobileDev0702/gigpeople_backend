		...
		<div class="col-xl-9 col-lg-9 content-right-offset">
			...
			<div class="boxed-list margin-bottom-60">
                 <div class="centered-button margin-top-35">
					<a href="<?php echo site_url();?>/welcome/mySales" class="button ripple-effect big margin-top-30">Accept<i class="icon-material-outline-arrow-right-alt"></i></a>
					<a href="<?php echo site_url();?>/welcome/mySales" class="button ripple-effect big margin-top-30">Reject<i class="icon-material-outline-arrow-right-alt"></i></a>
				</div>
