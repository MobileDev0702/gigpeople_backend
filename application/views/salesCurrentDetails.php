...
" style="font-size: 20px"></i></div>
			...
			<div class="boxed-list margin-bottom-60">
				...
				<ul class="boxed-list-ul">
					...
					<li>
					<div class="centered-button margin-top-35">
					<a href="#small-dialog-2" class="popup-with-zoom-anim button button-sliding-icon">Deliver Now<i class="icon-material-outline-arrow-right-alt"></i></a>
				</div>
					</li>
				</ul>
				...
				<form method="post" id="apply-now-form">
					...
					<div class="input-with-icon-left">
						...
						<div class="uploadButton margin-top-30">
							...
							<span class="uploadButton-file-name">Images or Videos that might be helpful in describing your Sales</span>
						</div>
					...
					<div class="input-with-icon-left">
						...
						<textarea class="input-text with-border" name="name" id="name" placeholder="Description"  required></textarea>
					</div>
