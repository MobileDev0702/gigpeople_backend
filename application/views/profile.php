					...
					<div class="header-notifications user-menu">
						...
						<div class="header-notifications-dropdown">
							...
							<div class="user-status">
								...
								<div class="status-switch" id="snackbar-user-status" style="dipslay:none">
				...
				<!-- Navigation -->
					...
					<div class="dashboard-nav-inner">
						...
						<ul data-submenu-title="Account">
							<li class="active"><a href="<?php echo site_url();?>/welcome/profile"><i class="icon-feather-user-plus"></i>Profile</a>
...
"></i></div>
			...
			<div class="row">
                ...
                <div class="switches-list" style="float:right">
								...
								<div class="col">
									<div class="row">
										...
										<div class="col-xl-6">
											<div class="submit-field">
												<h5>Mobile no</h5>
												<input type="text" class="with-border" value="+727273727">
											</div>
										</div>
			...
			<div class="keywords-container">
				<div class="keyword-input-container">
					<input type="text" class="keyword-input with-border" placeholder="Add Languages">
					<button class="keyword-input-button ripple-effect"><i class="icon-material-outline-add"></i></button>
				</div>
				<div class="keywords-list" style="height: auto;">
					<span class="keyword"><span class="keyword-remove"></span><span class="keyword-text">English</span></span>
					<span class="keyword"><span class="keyword-remove"></span><span class="keyword-text">French</span></span>
					<span class="keyword"><span class="keyword-remove"></span><span class="keyword-text">Arabic</span></span>
					<span class="keyword"><span class="keyword-remove"></span><span class="keyword-text">Urdu</span></span>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
