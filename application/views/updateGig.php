					...
					<div class="dashboard-nav-inner">
						...
						<ul data-submenu-title="Start">
						   ...
						   <!--  <li ><a href="<?php echo site_url();?>/welcome/bookmark"><i class="icon-material-outline-star-border"></i>Favourite</a></li> -->
							...
							<li class="active"><a href="<?php echo site_url();?>/welcome/myGigs"><i class="icon-feather-git-merge"></i>My Gigs</a>
							</li>
		...
		<div class="dashboard-content-inner" >
			...
			<div class="row">
				...
				<div class="col-xl-12">
					<div class="dashboard-box margin-top-0">
						...
						<!-- Headline -->
						<div class="headline">
							<h3><i class="icon-feather-folder-plus"></i>Update</h3>
						</div>
						...
						<div class="content with-padding padding-bottom-10">
							<div class="row">
								...
								<div class="col-xl-4">
									<div class="submit-field">
										...
										<div class="wrapper1">
                                            ...
                                            <span>I will </span>   <input type="text" class="with-border" placeholder="Do best Designing" style="padding-left: 48px;">
                                        </div>
								...
								<div class="col-xl-6">
									<div class="submit-field">
										<h5>Revisions <i class="help-icon" data-tippy-placement="right" title="Up to 5 skills that best describe your project"></i></h5>
										<div class="keywords-container">
											<div class="keyword-input-container">
												<select class="selectpicker with-border" data-size="7" title="Select Revisions">
											<option>0</option>
											<option>1</option>
											<option>2</option>
											<option>3</option>
								...
								<div class="col-xl-6">
									<div class="submit-field">
										<h5>Search Tags <i class="help-icon" data-tippy-placement="right" title="Up to 5 skills that best describe your project"></i></h5>
										<div class="keywords-container">
											<div class="keywords-container">
				<div class="keyword-input-container">
				...
				<div class="keywords-list" style="height: auto;">
					<span class="keyword"><span class="keyword-remove"></span><span class="keyword-text">Mustard</span></span>
					
					<span class="keyword"><span class="keyword-remove"></span><span class="keyword-text">Ketchup</span></span>
					<span class="keyword"><span class="keyword-remove"></span><span class="keyword-text">Tabasco</span></span>
				<span class="keyword"><span class="keyword-remove"></span><span class="keyword-text">qqqq</span></span></div>
				<div class="clearfix"></div>
			</div>
											<div class="keywords-list"><!-- keywords go here --></div>
											<div class="clearfix"></div>
								...
								<div class="col-xl-12">
									<div class="submit-field">
										<button class="keyword-input-button ripple-effect" onclick="addDynamic()"><h5>Add Extra Gig<i class="icon-material-outline-add"></i></h5></button>

										<div id="extraAdds">
											<!-- tr><td width="100">Title</td><td><input type="text" class="with-border" placeholder="Title your extra service"></td></tr>
				...
				<div class="col-xl-12">
					<a href="<?php echo site_url();?>//welcome/myGigs" class="button ripple-effect big margin-top-30"><i class="icon-feather-plus"></i>Update a Gig</a>
				</div>
			...
			<div class="small-footer margin-top-15">
				<div class="small-footer-copyrights">
					© 2019 <strong><?php $this->config->item('app_name');?></strong>. All Rights Reserved.
				</div>
