					...
					<div class="dashboard-nav-inner">
						...
						<ul data-submenu-title="Start">
						   ...
						   <!--  <li ><a href="<?php echo site_url();?>/welcome/bookmark"><i class="icon-material-outline-star-border"></i>Favourite</a></li> -->
							...
							<li class="active"><a href="<?php echo site_url();?>/welcome/mySales"><i class="icon-feather-pocket"></i>My Sales</a>
		...
		<div class="dashboard-content-inner" >
			...
			<div class="row">
				...
				<div class="fun-fact" data-fun-fact-color="#efa80f">
					<div class="fun-fact-text">
						<span>Revenue of this Month($)</span>
						<h4>28</h4>
					</div>
			...
			<div class="row">
				...
				<!-- Dashboard Box -->
				 <div class="col-xl-12">
						...
						<div class="notify-box margin-top-15">
							<div class="sort-by">
								...
								<select class="selectpicker hide-tick" id="select">
									...
									<option id="cancel">Cancelled</option>
								</select>
							</div>
					    </div>
					</div>

					<div class="listings-container margin-top-35" id="requestdiv">		

						<!-- Job Listing -->
						<a href="<?php echo site_url();?>/welcome/salesRequestDetails" class="job-listing">
							...
							<div class="job-listing-details">
								...
								<div class="job-listing-description">
									<h4 class="job-listing-company">Jhon</h4>
					...
					<div class="listings-container margin-top-35" id="currentdiv">		

						<!-- Job Listing -->
						<a href="<?php echo site_url();?>/welcome/salesCurrentDetails" class="job-listing">
							...
							<div class="job-listing-details">
								...
								<!-- Details -->
								<div class="job-listing-description">
									<h4 class="job-listing-company">Smith</h4>
									<h3 class="job-listing-title">Barista and Cashier</h3>
									<p class="job-listing-text">Leverage agile frameworks to provide a robust synopsis for high level overviews. Iterative approaches to corporate strategy foster collaborative thinking to further the overall value.</p>
								</div>
					...
					<div class="listings-container margin-top-35" id="completeddiv">		

						<!-- Job Listing -->
						<a href="<?php echo site_url();?>/welcome/mySalesDetails" class="job-listing">

							<!-- Job Listing Details -->
							<div class="job-listing-details">
								<!-- Logo -->
								<div class="job-listing-company-logo">
									<img src="<?php echo base_url();?>/assets/images/user-avatar-big-02.jpg" alt="">
								</div>

								<!-- Details -->
								<div class="job-listing-description">
									<h4 class="job-listing-company">Jhony</h4>
					...
					<div class="listings-container margin-top-35" id="canceldiv">		

						<!-- Job Listing -->
						<a href="<?php echo site_url();?>/welcome/salesCancelDetails" class="job-listing">

							<!-- Job Listing Details -->
							<div class="job-listing-details">
								<!-- Logo -->
								<div class="job-listing-company-logo">
									<img src="<?php echo base_url();?>/assets/images/user-avatar-big-03.jpg" alt="">
								</div>

								<!-- Details -->
								<div class="job-listing-description">
									<h4 class="job-listing-company">Jhon smith</h4>
									<h3 class="job-listing-title">Barista and Cashier</h3>
									<p class="job-listing-text">Leverage agile frameworks to provide a robust synopsis for high level overviews. Iterative approaches to corporate strategy foster collaborative thinking to further the overall value.</p>
								</div>
...
function callOpen()
{
	 window.location.href="<?php echo site_url();?>/welcome/mySalesDetails";
}
