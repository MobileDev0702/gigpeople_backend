										...
										<li class="notifications-not-read">
											<a href="#">
												...
												<span class="notification-text">
													<strong>Michael Shannah</strong> Send Update request for  <span class="color">Full Stack Software Engineer</span>
												</span>
											</a>
										</li>
				...
				<div class="header-widget">
					...
					<div class="header-notifications user-menu">
						...
						<ul class="user-menu-small-nav">
							...
							<li><a href="<?php echo site_url();?>/welcome/home"><i class="icon-material-outline-power-settings-Update"></i> Logout</a></li>
						</ul>
	...
	<div class="dashboard-content-container" data-simplebar>
		<div class="dashboard-content-inner" >
			...
			<div class="row">
				...
				<div class="col-xl-12">
					<a href="<?php echo site_url();?>/welcome/manageRequests" class="button ripple-effect big margin-top-30"><i class="icon-feather-plus"></i> Update a Request</a>
				</div>
...
<script>
	function initAutocomplete() {
		 ...
		 var autocomplete = Update google.maps.places.Autocomplete(input, options);
