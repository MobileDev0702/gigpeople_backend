						...
						<div class="content with-padding padding-bottom-10">
							<div class="row">
								...
								<div class="col-xl-12">
										...
										<input type="Text" class="with-border" placeholder="Refund Amount" style="background-color: white;">
								</div>
								<div class="col-xl-12">
									
										<textarea cols="30" rows="5" class="with-border" placeholder="Refund reason"></textarea>
										
					              </div>

				<div class="col-xl-9">
					<a href="#" class="button ripple-effect big margin-top-30 col-sm-6"><span style="margin-left:100px;">Submit</span></a>
