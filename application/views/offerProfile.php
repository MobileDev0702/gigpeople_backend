				...
				<div class="single-page-header-inner">
					<div class="left-side">
						...
						<div class="header-details">
							...
							<h4>Member since : 2019</h4>
							<h4>Orders Completed : 2</h4>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-12 col-lg-8 content-right-offset">
			...
			<div class="boxed-list margin-bottom-60">
				<div class="boxed-list-headline">
					<h3><i class="icon-material-outline-thumb-up"></i> Buyer Description</h3>
				</div>
					...
					<li>
						<div class="boxed-list-item">
							...
							<div class="item-content">
								<h4>Delivery time : 1 Days </h4>
								<h4>Price: $1.00 </h4>
								<h4>Description: Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.  </h4>
							</div>
						</div>
					</li>
				...
				<a href="#" class="button ripple-effect big margin-top-30"> Accept & Pay</a>

				<a href="#" class="button ripple-effect big margin-top-30 btn-danger"> Reject</a>
