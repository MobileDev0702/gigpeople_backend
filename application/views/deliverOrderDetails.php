...
" style="font-size: 20px"></i></div>
			...
			<center><a href="#small-dialog-3" class="popup-with-zoom-anim button button-sliding-icon">Delivery Satisfied <i class="icon-material-outline-arrow-right-alt"></i></a></center>
			...
			<div class="popup-tab-content" id="tab2">
				...
				<form method="post" id="leave-review-form">
					...
					<div class="feedback-yes-no">
						<strong>Delivery Satisfied?</strong>
						<div class="radio">
