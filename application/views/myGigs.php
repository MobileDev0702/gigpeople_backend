	...
	<div class="dashboard-content-container" data-simplebar>
		<div class="dashboard-content-inner" >
			...
			<div class="dashboard-headline">
				...
				<a href="<?php echo site_url();?>/welcome/newGigs" class="button gray ripple-effect ico" title="Add New Gigs" data-tippy-placement="top"><i class="icon-material-outline-add-circle-outline
"></i></a>
			...
			<div class="row">
				...
				<div class="col-xl-12">
						...
						<div class="notify-box margin-top-15">
							<div class="sort-by">
								...
								<select class="selectpicker hide-tick" id="select">
									...
									<option id="draft">Draft/Paused</option>
									<option id="denied">Denied</option>
								</select>
							</div>
					    </div>
					</div>
					<div class="freelancers-container freelancers-list-layout margin-top-35" id="alldiv">
						...
						<div class="freelancer">
							...
							<div class="freelancer-overview">
								<div class="freelancer-overview-inner">
									...
									<!-- Name -->
									<div class="freelancer-name"><span><b>Created On:17/08/2019</b></span>
										<h4><a href="<?php echo site_url();?>/welcome/gigDetailsAll">I Will Create Complete And Secure Website In PHP And Mysql </a></h4>
					...
					<div class="freelancers-container freelancers-list-layout margin-top-35" id="draftdiv">
						...
						<div class="freelancer">
							...
							<div class="freelancer-overview">
								<div class="freelancer-overview-inner">
									...
									<!-- Name -->
									<div class="freelancer-name"><span><b>Created On:17/08/2019</b></span>
										<h4><a href="<?php echo site_url();?>/welcome/gigDetails">I Will Create Complete And Secure Website In PHP And Mysql </a></h4>
										<span>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</span>
									</div>
									<div class="task-tags">
										<a href="#" class="button gray ripple-effect ico" title="Share" data-tippy-placement="top"><i class="icon-feather-share-2"></i></a>
					...
					<div class="freelancers-container freelancers-list-layout margin-top-35" id="denieddiv">
