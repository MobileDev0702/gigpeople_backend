...
<p>Qty : 1 </p>
				...
				<p>Capitalize on low hanging fruit to identify a ballpark value added activity to beta test. Override the digital divide with additional clickthroughs from DevOps. Nanotechnology immersion along the information highway will close the loop on focusing solely on the bottom line.</p>
					...
					<a href="<?php echo site_url();?>/welcome/updateGig" class="button ripple-effect big margin-top-30"><i class="icon-feather-plus"></i> Edit Gig</a>

					<a href="<?php echo site_url();?>/welcome/myGigs" class="button ripple-effect big margin-top-30" style="background-color:blue;"><i class="icon-material-outline-arrow-forward"></i>Publish Gig</a>
