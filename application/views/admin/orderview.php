...
$( document ).ready(function() {
    ...
    document.getElementById("myOrderMenu").className="menu active";
});
</script>         
                     ...
                     <div class="row align-items-end">
                      ...
                      <div class="page-header-breadcrumb">
                           <ul class="breadcrumb-title">
                               ...
                               <!-- </li>-->
                                <li class="breadcrumb-item"><a href="<?php echo site_url();?>admin/myorder">Order</a></li>
                                ...
                                <div class="card-block">
                                      ...
                                      <div class="col-xl-6 col-md-12">
                                                    ...
                                                    <div class="row m-l-0 m-r-0">
                                                        <div class="col-sm-4 bg-c-lite-green user-profile">
                                                            <div class="card-block text-center text-white">
                                                                <div class="m-b-25">
                                                                    <img src="<?php echo base_url()?>uploads/profile/<?php echo !empty($CI->getUserDetails($seller_id)->profile_picture) ? $CI->getUserDetails($seller_id)->profile_picture : 'profile.png';?>" style="height:70px;width:auto" class="img-radius" alt="User-Profile-Image">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-8">
                                              ...
                                              <!-- <div class="col-xl-6 col-md-6">
                                                <div class="card">
                                                    <div class="card-block text-center">
                                                        <i class="feather icon-alert-circle text-c-yellow d-block f-40"></i>
                                                        <h4 class="m-t-15">Order Dispute</h4>
                                              ...
                                              <div class="col-xl-6 col-md-6">
                                                <div class="card">
                                                    <div class="card-block text-center">
                                                        <i class="feather icon-x-circle text-c-lite-green d-block f-40"></i>
                                                        <h4 class="m-t-15">Order Cancelled</h4>
                                                       ...
                                                       <ul class="media-list">
                                                        ...
                                                        <li class="media">
                                                            <div class="media-left">
                                                                <a href="#">
                                                                <img src="<?php echo base_url()?>uploads/profile/<?php echo !empty($CI->getUserDetails($reviews->seller_id)->profile_picture) ? $CI->getUserDetails($reviews->seller_id)->profile_picture : 'profile.png';?>" style="height:70px;width:auto" class="media-object img-radius comment-img">
                                                                </a>
                                                            </div>
