...
document.getElementById("sellerMenu").className = "active";
});
</script>
...
<div class="col-sm-12">
   ...
   <div class="card">
       ...
       <?php 
$i=1;
foreach ($seller_details as $key => $value) 
{
    $user_id = $value['id'];
?>
...
<tr>
    ...
    <td>
        ...
        if($value['account_status']==0)
        {
            ...
            {
                //echo '<button class="btn btn-success" data-toggle="modal"  data-target="#activate" id='.$user_id.' onclick="activate(this.id)"><i class="fa fa-thumbs-up"></i></button>';
                
                echo ' <button class="btn btn-warning" data-toggle="modal"  data-target="#deactivate" id='.$user_id.' onclick="deactive(this.id)"><i class="fa fa-thumbs-down"></i></button>';
            }
        ...
        <a href="<?php echo site_url();?>admin/sellerview/<?php echo $user_id?>" class="btn btn-info"  id="" onclick=""><i class="fa fa-eye"></i></button></a>
...
<script type="text/javascript">
    ...
    function confirmFilter(id)
    {
        if(id=='1')
        {
            window.location.href="<?php echo site_url();?>admin/sellerlist/1";
        }
        else if(id=='2')
        {
            window.location.href="<?php echo site_url();?>admin/sellerlist/2";
        }
        else
        {
            window.location.href="<?php echo site_url();?>admin/sellerlist";   
        } 
    }
</script>
