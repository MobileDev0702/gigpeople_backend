...
$( document ).ready(function() {
    ...
    document.getElementById("cmsMenu").className = "pcoded-hasmenu pcoded-trigger";
     document.getElementById("privacyMenu").className = "active";
});
</script> 
       <!--  for modals -->
<style>
                        ...
                        <div class="page-header-breadcrumb">
                            <ul class="breadcrumb-title">
                                ...
                                <li class="breadcrumb-item"><a href="">CMS</a>
                                 ...
                                 <li class="breadcrumb-item"><a href="#!">Privacy Policy</a>
                                 </li>
                             </ul>
                        </div>
                    </div>
                        ...
                        <div class="card">
                             <div class="card-header">
                              ...
                              <div class="card-block">
                                 <form class="form" method="POST" id="privacyAdd">
                                     <div class="form-body">
                                        <div class="form-group">
                                           <div class="adjoined-bottom">
                                              <div class="grid-container">
                                                  <div class="grid-width-100">
                                                     <textarea name="content" class="editor" id="editor" ><?php echo $admin_details->privacy?></textarea>
                                                  </div>
                                               </div>
                                             </div>
                                         </div>
...
<script type="text/javascript">
    ...
    $( "#privacyAdd" ).submit(function( event ) {
        ...
        var terms=CKEDITOR.instances.editor.getData();
              ...
              url : '<?php echo site_url();?>admin/updatePrivacy',
              ...
              data:
              {
                  ...
                  privacy: CKEDITOR.instances.editor.getData(),
